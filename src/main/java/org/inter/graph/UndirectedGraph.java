...
/**
 * The {@code UndirectedGraph} represents working implementation of undirected graph.
 *
 * @author ivanefanov
 */
@Getter
@Setter
public class UndirectedGraph<T extends Vertex> implements Graph<T> {
    ...
    /**
     * Method to add edges between source vertex and target.
     *
